...
为有暗香来。`, isGarden: true },
    ...
    { unit: "第二单元（识字）", lessons: [
        { title: "识字 1 场景歌", audio: "https://ywld-1315558954.51jiaoxi.com/yw-static/lesson/1/132948-132969.mp3", content: `一只海鸥，一片沙滩。一艘军舰，一条帆船。
一方鱼塘，一块稻田。一行垂柳，一座花园。
一道小溪，一孔石桥。一丛翠竹，一群飞鸟。
一面队旗，一把铜号。一队"红领巾"，一片欢笑。`, recognize: "滩 艘 舰 帆 稻 园 翠 丛 队 旗 铜 号", write: "园 孔 桥 群 队 旗 铜 号 领 巾", keyWords: "沙滩、军舰、帆船、稻田、垂柳、石桥、翠竹、队旗、铜号、红领巾" },
